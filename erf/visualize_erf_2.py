...
from resnet_for_erf import resnet101, resnet152, resnet50
from repmnet_for_erf import RepMNet
...
def main(args):
    ...
    data_loader_val = torch.utils.data.DataLoader(dataset, sampler=sampler_val,
        batch_size=16, num_workers=1, pin_memory=True, drop_last=False)
    ...
    #                 small_kernel=5, small_kernel_merged=False)
        ...
        model = resnet50()
    elif args.model == 'repmnet':
        model = RepMNet(num_classes=1000, deploy=True)
