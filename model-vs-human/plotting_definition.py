...
def plotting_definition_template(df):
    ...
    decision_makers.append(DecisionMaker(name_pattern="resnet50",
                           color=rgb(142, 207, 201), marker="o", df=df,
                           plotting_name="ResNet-50"))
    decision_makers.append(DecisionMaker(name_pattern="repmnet",
                           color=rgb(255, 190, 122), marker="o", df=df,
                           plotting_name="RepMNet"))
    ...
    decision_makers.append(DecisionMaker(name_pattern="subject-*",
                           color=rgb(250, 127, 111), marker="D", df=df,
