...
def repmnet(model_name, *args):
    if model_name == 'repmnet':
        model = RepMNet(num_classes=1000)
    weights = torch.load('/data/demo/model-vs-human-master/checkpoint-best.pth', map_location='cpu')
